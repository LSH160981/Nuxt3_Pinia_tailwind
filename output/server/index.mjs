globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, readBody, createError } from 'file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/node_modules/ofetch/dist/node.mjs';
import destr from 'file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/node_modules/radix3/dist/index.mjs';
...
const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false},"/tailwindDemo/**":{"prerender":true},"/about":{"ssr":false},"/demo/**":{"redirect":{"to":"/","statusCode":307}},"/**":{"headers":{"cache-control":"s-maxage=114514"}}}},"public":{"publicConst":"This is a public const"},"isServeConst":true,"privateConst":"This is a server cosnt"};
...
const serverAssets = [{"baseName":"server","dir":"F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"F:\\Code\\Vue3+Nuxt3\\Vue3+Nuxt3_study","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"F:\\Code\\Vue3+Nuxt3\\Vue3+Nuxt3_study\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"F:\\Code\\Vue3+Nuxt3\\Vue3+Nuxt3_study\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"F:\\Code\\Vue3+Nuxt3\\Vue3+Nuxt3_study\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_0ElStp = () => Promise.resolve().then(function () { return _____$1; });
const _lazy_gMPWth = () => Promise.resolve().then(function () { return aaa$1; });
const _lazy_vPfgM1 = () => Promise.resolve().then(function () { return _age_$1; });
const _lazy_H5qbv3 = () => Promise.resolve().then(function () { return ccc_get$1; });
const _lazy_krdCzr = () => Promise.resolve().then(function () { return ddd_post$1; });
const _lazy_GaxkMb = () => Promise.resolve().then(function () { return random_post$1; });
const _lazy_Y7KdCc = () => Promise.resolve().then(function () { return renderer$1; });
...
const aaa$1 = /*#__PURE__*/Object.freeze({
      __proto__: null,
      default: aaa
});
...
const _age_$1 = /*#__PURE__*/Object.freeze({
      __proto__: null,
      default: _age_
});
...
const ccc_get$1 = /*#__PURE__*/Object.freeze({
      __proto__: null,
      default: ccc_get
});
...
const ddd_post$1 = /*#__PURE__*/Object.freeze({
      __proto__: null,
      default: ddd_post
});
...
const random_post$1 = /*#__PURE__*/Object.freeze({
      __proto__: null,
      default: random_post
});
...
const getClientManifest = () => import('file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://F:/Code/Vue3+Nuxt3/Vue3+Nuxt3_study/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<meta name=\"keywords\" content=\"lSH的一次练习\">\n<meta name=\"description\" content=\"练习,Nuxt3,Vue3\">","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
